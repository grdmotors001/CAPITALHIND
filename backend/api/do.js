...
import route_list_tvr_2 from '../lib/api/do/list-tvr.js';
import route_decide_tvr_3 from '../lib/api/do/decide-tvr.js';

const routes = {
  '/decide': route_decide_0,
  '/list-pending': route_list_pending_1,
  '/list-tvr': route_list_tvr_2,
  '/decide-tvr': route_decide_tvr_3,
};
